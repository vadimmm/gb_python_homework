...
fibonacci_list = []
numbFibonacci_1, numbFibonacci_2 = 0, 1
fibonacci_list.append(numbFibonacci_1)
fibonacci_list.append(numbFibonacci_2)
fibonacci_list.append(-numbFibonacci_2)

count = 0
while count < k-1:
    sumFibonacci = numbFibonacci_1 + numbFibonacci_2
    numbFibonacci_1 = numbFibonacci_2
    numbFibonacci_2 = sumFibonacci
    fibonacci_list.append(sumFibonacci)
    fibonacci_list.append(-sumFibonacci)
    count += 1

result = sorted(fibonacci_list)
print(f'\nОТВЕТ: Последовательность Фибоначчи {result}')